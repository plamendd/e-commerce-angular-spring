...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formbuilder: FormBuilder,
    ...
    private checkooutService: CheckoutService,
  ...
  onSubmit() {
    ...
    purchase.billingAddress.country = shippingAddressCountry.name;
    ...
    this.checkooutService.placeOrder(purchase).subscribe({
        next: response => {
  ...
  resetCart(){
    ...
    //navigate back to the prodiucts page
